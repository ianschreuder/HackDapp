...
contract Settlement{
	...
	function getBuyer(address affiliate) returns (address) {
		return affiliates[affiliate].buyer;
	}

	function getVendor(address affiliate) returns (address) {
		return affiliates[affiliate].vendor;
	}
